...
describe('quoteMetaNFT', function () {
  let admin: Signer;
  let user1: Signer;
  let user2: Signer;
  let user3: Signer;
  ...
  it('CORE_020201', async function (): Promise<void> {
    const tags: string[] = [];
    ...
    await runROMethod({
      method: listingFacet.connect(user1).functions.quoteMetaNft(metaNftId),
      expectedArgs: {
  ...
  it('CORE_020202', async function (): Promise<void> {
    const tags: string[] = [];
  ...
  it('CORE_020203', async function (): Promise<void> {
    const metaNftId = 0;
    await runROMethod({
      method: listingFacet.connect(user1).functions.quoteMetaNft(metaNftId),
      expectRevert: true,
  ...
  it('CORE_020204', async function (): Promise<void> {
    const tags: string[] = [];
  ...
  it('CORE_020205', async function (): Promise<void> {
    const tags: string[] = [];
