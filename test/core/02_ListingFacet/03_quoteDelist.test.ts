...
describe('quoteDelist', function () {
  ...
  it('CORE_020301', async function (): Promise<void> {
    const tags: string[] = [];
    ...
    await runROMethod({
      method: listingFacet.connect(user1).functions.quoteDelist(metaNftId),
      expectedArgs: {
  ...
  it('CORE_020302', async function (): Promise<void> {
    const tags: string[] = [];
  ...
  it('CORE_020303', async function (): Promise<void> {
    const metaNftId = 0;
    await runROMethod({
      method: listingFacet.connect(user1).functions.quoteDelist(metaNftId),
      expectRevert: true,
  ...
  it('CORE_020304', async function (): Promise<void> {
    const tags: string[] = [];
  ...
  it('CORE_020305', async function (): Promise<void> {
    const tags: string[] = [];
