...
describe('unbidNFT', function () {
  ...
  // Unbid when expired
  it('CORE_021201', async function (): Promise<void> {
    ...
    await runRWMethod({
      ...
      name: 'Unbid',
      expectedArgs: {
        _amountOut: beforeNftFee(g0NFT),
      },
    });
  });

  // Unbid when pair is latest but delisted
  it('CORE_021202', async function (): Promise<void> {
    const listReulst = await runRWMethod({
      method: listingFacet.connect(user1).list(
        testERC721.address,
        tokenId,
  ...
  it('CORE_021203', async function (): Promise<void> {
    const listReulst = await runRWMethod({
      method: listingFacet.connect(user1).list(
        testERC721.address,
        tokenId,
  ...
  it('CORE_021204', async function (): Promise<void> {
    await managingFacet.setBidTimeout(minBidTimeOut);
  ...
  it('CORE_021205', async function (): Promise<void> {
    await managingFacet.setBidTimeout(minBidTimeOut);
    ...
    await runRWMethod({
      method: listingFacet.connect(user3).unbidNft(
        metaNftId,
        deadline,
      ),
      name: 'Unbid',
  ...
  it('CORE_021206', async function (): Promise<void> {
    const metaNftId: BigNumberish = 0;

    await runRWMethod({
      method: listingFacet.connect(user1).unbidNft(
        metaNftId,
        deadline,
      ),
      name: 'Unbid',
  ...
  it('CORE_021207', async function (): Promise<void> {
    const listReulst = await runRWMethod({
      method: listingFacet.connect(user1).list(
        testERC721.address,
        tokenId,
  ...
  it('CORE_021208', async function (): Promise<void> {
    await managingFacet.setBidTimeout(minBidTimeOut);
  ...
  it('CORE_021209', async function (): Promise<void> {
    await managingFacet.setBidTimeout(minBidTimeOut);
