...
describe('quoteSellExactRounds', function () {
  let admin: Signer;
  let user1: Signer;
  let user2: Signer;
  let user3: Signer;
  ...
  it('CORE_010301', async function (): Promise<void> {
    const tags: string[] = [];
    ...
    await runROMethod({
      method: aMMFacet
        .connect(user1)
        .functions.quoteSellExactRounds(metaNftId, tenPercent),
    });
  });

  // Quote with all rounds minted
  it('CORE_010302', async function (): Promise<void> {
    const tags: string[] = [];
  ...
  it('CORE_010303', async function (): Promise<void> {
    const metaNftId = 0;

    await runROMethod({
      method: aMMFacet
        .connect(user1)
        .functions.quoteSellExactRounds(metaNftId, 10),
      expectRevert: true,
    });
  });

  // Quote with non-latest _metaNftId
  it('CORE_010304', async function (): Promise<void> {
    const tags: string[] = [];
  ...
  it('CORE_010305', async function (): Promise<void> {
    const tags: string[] = [];
  ...
  // Quote with zero _roundIn
  it('CORE_010306', async function (): Promise<void> {
    const tags: string[] = [];
    ...
    await runROMethod({
      method: aMMFacet
        .connect(user1)
        .functions.quoteSellExactRounds(metaNftId, zeroEther),
      expectRevert: true,
    });
  });

  // Quote with _roundIn less than round unit
  it('CORE_010307', async function (): Promise<void> {
    const tags: string[] = [];
    ...
    await runROMethod({
      method: aMMFacet
        .connect(user1)
        .functions.quoteSellExactRounds(metaNftId, roundUnit.sub(1)),
      expectRevert: true,
    });
  });

  // Quote with more _roundIn than round minted
  it('CORE_010308', async function (): Promise<void> {
    const tags: string[] = [];
    ...
    await runROMethod({
      method: aMMFacet
        .connect(user1)
        .functions.quoteSellExactRounds(metaNftId, twentyPercent),
      expectRevert: true,
    });
  });

  // Quote when just listed
  it('CORE_010309', async function (): Promise<void> {
    const tags: string[] = [];
